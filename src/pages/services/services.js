      ...
      <div className="services-page__top_content">
        ...
        <div className="top_content">
          ...
          <div className="sub-content">
            تقرر انطلاق الفاتورة الإلكترونية وتطبيقها على كبار الممولين اعتبارًا
            من تاريخ ١٥ فبراير ٢٠٢١ طبقًا للقانون رقم ٥١٨ لسنة ٢٠٢٠ الصادر من
            مصلحة الضرائب المصرية، بإلزام ٣٤٧ شركة مسجلة بالمركز الضريبي لكبار
            الممولين بإصدار فواتير ضريبية إلكترونية -كمرحلة ثانية- لكل ما تقوم
            ببيعه أو تؤديه من خدمات، وهذا بعد الانتهاء من المرحلة الأولى والتي
            تضم ١٣٤ شركة؛ وذلك تمهيدًا لإلغاء التعامل الورقي ولتوفير الوقت
            ولبيانات أكثر دقةتقرر انطلاق الفاتورة
          </div>
        </div>
      </div>
